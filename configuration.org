...
#+BEGIN_SRC emacs-lisp
  (use-package mu4e
    ...
    :init
    (progn
      (defvar np-mu4e-combined-inbox-bookmark "maildir:/inbox OR maildir:/flagged" "What I consider to be my 'inbox'")
      (setq mu4e-mu-binary "/usr/local/bin/mu"
            mu4e-maildir (expand-file-name "~/mail/gmail-personal")
            ...
            mu4e-view-image-max-width 800 ;; note this won't work without "emacs with imagemagick support"
            ...
            '( ("/inbox"     . ?i)
               ...
               ("/sent"      . ?s))
            mu4e-bookmarks
            '((np-mu4e-combined-inbox-bookmark "Smart Inbox" ?i)
              ((concat "(" np-mu4e-combined-inbox-bookmark ") AND flag:unread") "Unread" ?u)))))
  ...
  (use-package smtpmail
    ...
    (setq message-send-mail-function 'smtpmail-send-it
          ...
          smtpmail-auth-credentials
            '(("smtp.gmail.com" 587 "natalie.pendragon@gmail.com" nil))
          ...
          ;; the following the two setting ensure offline composition works
          smtpmail-queue-mail nil
          smtpmail-queue-dir (concat mu4e-maildir "/send-queue/cur")))
